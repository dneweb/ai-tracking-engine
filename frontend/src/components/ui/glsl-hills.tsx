...
const GLSLHills = ({
  ...
  // Update uniform when theme changes without recreating the scene
  useEffect(() => {
    if (planeRef.current) {
      planeRef.current.uniforms.uIsDark.value = theme === 'dark' ? 1.0 : 0.0;
    }
  }, [theme]);
          ...
          new THREE.RawShaderMaterial({
            ...
            fragmentShader: `
              ...
              void main(void) {
                ...
                float opacity = (96.0 - dist) / 256.0 * mix(0.35, 0.6, uIsDark);
                
                // Dark: #2d8fff, Light: Midnight Sapphire #164192
                vec3 darkColor = vec3(0.176, 0.561, 1.0);
                vec3 lightColor = vec3(0.086, 0.255, 0.573);
